...
def mutation(crossover, numberOfParameters, selectedParentsStats):
    ...
    for i in mutation:
        ...
        if percentageCheck < mutationPercentage:
            ...
            #Hyper-parameter 0
            newParameter0 = round(np.random.normal(selectedParentsStats['mean'][0], selectedParentsStats['sd'][0]),2)
            ...
            #Hyper-parameter 1
            newParameter1 = round(np.random.normal(selectedParentsStats['mean'][1], selectedParentsStats['sd'][1]),0)
            ...
            #Hyper-parameter 2
            newParameter2 = round(np.random.normal(selectedParentsStats['mean'][2], selectedParentsStats['sd'][2]),0)
            ...
            #Hyper-parameter 3
            newParameter3 = round(np.random.normal(selectedParentsStats['mean'][3], selectedParentsStats['sd'][3]),2)
            ...
            #Hyper-parameter 4
            newParameter4 = round(np.random.normal(selectedParentsStats['mean'][4], selectedParentsStats['sd'][4]),2)
            ...
            #Hyper-parameter 5
            newParameter5 = round(np.random.normal(selectedParentsStats['mean'][5], selectedParentsStats['sd'][5]),2)
            ...
            #Hyper-parameter 6
            newParameter6 = round(np.random.normal(selectedParentsStats['mean'][6], selectedParentsStats['sd'][6]),2)
